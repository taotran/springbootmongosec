...
public class MyBasicLookupStrategy implements LookupStrategy {

    private static final Logger LOGGER = LoggerFactory.getLogger(MyBasicLookupStrategy.class);
    ...
    private void lookupPrimaryKeys(final Map<Serializable, Acl> acls,
        ...
        Set<Long> parentsToLookup = jdbcTemplate.query(sql,
                ...
                }, new MyBasicLookupStrategy.ProcessResultSet(acls, sids));
    ...
    private AclImpl convert(Map<Serializable, Acl> inputMap, Long currentIdentity) {
        ...
        if ((parent != null) && parent instanceof MyBasicLookupStrategy.StubAclParent) {
            // Lookup the parent
            MyBasicLookupStrategy.StubAclParent stubAclParent = (MyBasicLookupStrategy.StubAclParent) parent;
    ...
    private class ProcessResultSet implements ResultSetExtractor<Set<Long>> {
        ...
        private void convertCurrentResultIntoObject(Map<Serializable, Acl> acls,
            ...
            if (acl == null) {
                ...
                if (parentAclId != 0) {
                    parentAcl = new MyBasicLookupStrategy.StubAclParent(Long.valueOf(parentAclId));
                }
